            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" required className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-[#F97316] outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
                  <input type="email" required className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-[#F97316] outline-none" />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Phone</label>
                <input type="tel" className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-[#F97316] outline-none" />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea rows={4} required className="w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-[#F97316] outline-none" />
              </div>
              <button type="submit" className="w-full bg-[#F97316] hover:bg-[#ea580c] text-white py-2.5 rounded-md font-medium transition-colors">
                Send Message
              </button>
            </form>
          )}
