  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-[#0F172A] mb-4">Downloads</h1>
      ...
      <div className="space-y-4">
        {downloads.map((d) => (
          <div key={d.id} className="bg-white rounded-lg shadow-sm border p-5 flex items-center justify-between">
            ...
            <button className="flex items-center gap-2 bg-[#F97316] hover:bg-[#ea580c] text-white px-4 py-2 rounded-md text-sm font-medium transition-colors">
