...
export default async function UmrahBookingsPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold">Umrah Bookings</h1>

      <div className="bg-white rounded-lg shadow-sm border">
        <div className="p-6 border-b">
          <h2 className="font-bold mb-4">New Umrah Booking</h2>
          <form action="/api/agent/bookings" method="POST" className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-end">
              <button type="submit" className="bg-[#F97316] hover:bg-[#ea580c] text-white px-4 py-2 rounded-md text-sm font-medium">Book Umrah</button>
            </div>
          </form>
        </div>

        <div className="p-6">
          <h2 className="font-bold mb-4">My Umrah Bookings</h2>
          {bookings.length === 0 ? (
